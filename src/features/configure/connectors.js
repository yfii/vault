...
const url = parseInt(Math.random() * 3, 10)
const RPC_URLS = {
  1: process.env["RPC_URL_1_" + url] ? process.env["RPC_URL_1_" + url] : process.env.RPC_URL_1_0,
  4: process.env["RPC_URL_4_" + url] ? process.env["RPC_URL_4_" + url] : process.env.RPC_URL_4_0
}
